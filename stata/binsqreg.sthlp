...
Recommended specification is {cmd:ci(3 3)}, which adds confidence intervals based on a cubic B-spline estimate of
the regression function of interest to the binned scatter plot.
{p_end}
