...
{p 4 12} {cmdab:binsqreg} {depvar} {it:indvar} [{it:covars}] {ifin} {weight} [ {cmd:,} {opt quantile(#)} {opt deriv(v)} {opt at(position)}{p_end}
...
{p 12 12} {cmd:vce(}{it:{help qreg##qreg_vcetype:vcetype}}{cmd:)} {opt level(level)}{p_end}
...
{p 8 8} . {stata binsqreg y x w, quantile(0.5)}{p_end}
