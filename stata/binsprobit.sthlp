...
{p 4 15} {cmdab:binsprobit} {depvar} {it:indvar} [{it:covars}] {ifin} {weight} [ {cmd:,} {opt deriv(v)} {opt at(position)} {opt nolink}{p_end}
...
When {opt by(varname)} is specified, {cmdab:binsprobit} implements estimation and inference by each subgroup separately, but produces a common binned scatter plot.
