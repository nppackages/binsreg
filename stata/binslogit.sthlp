...
When {opt by(varname)} is specified, {cmdab:binslogit} implements estimation and inference by each subgroup separately, but produces a common binned scatter plot.
