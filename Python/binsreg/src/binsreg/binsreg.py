...
def binsreg(y, x, w=None, data=None, at=None, deriv=0,
    ...
    opt = options(dots=dots, line=line, ci=ci, cb=cb,polyreg=polyreg, deriv=deriv,
                        binspos=position, binsmethod=selectmethod,
                        N_by=N_by, Ndist_by=Ndist_by, Nclust_by=Nclust_by,
                        nbins_by=nbins_by, byvals=byvals)

    out = binsreg_output(bins_plot=binsplot, data_plot=data_plot, cval_by=cval_by, options = opt)
    return out